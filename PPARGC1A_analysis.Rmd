...
## Male
```{r}
cau_lm_additive=lm(BMI ~ as.factor(FULLCAUGTAFF) + AGECOL + as.factor(SEX.x) + as.factor(DIABETES) +RS8192678_CC1_CT2_TT3, data = CAU[CAU$SEX.x ==1, ])
nzm_lm_additive=lm(BMI ~ as.factor(FULLEPGTAFF) + AGECOL + as.factor(SEX.x) + as.factor(DIABETES) +STANCESTRY+ RS8192678_CC1_CT2_TT3, data = nzm[nzm$SEX.x ==1, ])
cim_lm_additive=lm(BMI ~ as.factor(FULLEPGTAFF) + AGECOL + as.factor(SEX.x) + as.factor(DIABETES) +STANCESTRY+ RS8192678_CC1_CT2_TT3, data = cim[cim$SEX.x ==1, ])
samoan_lm_additive=lm(BMI ~ as.factor(FULLWPGTAFF) + AGECOL + as.factor(SEX.x) + as.factor(DIABETES) +STANCESTRY+ RS8192678_CC1_CT2_TT3, data = samoan[samoan$SEX.x ==1,])
tongan_lm_additive=lm(BMI ~ as.factor(FULLWPGTAFF) + AGECOL + as.factor(SEX.x) + as.factor(DIABETES) +STANCESTRY+ RS8192678_CC1_CT2_TT3, data = tongan[tongan$SEX.x == 1,])
...
## Female
```{r}
cau_lm_additive=lm(BMI ~ as.factor(FULLCAUGTAFF) + AGECOL + as.factor(SEX.x) + as.factor(DIABETES) +RS8192678_CC1_CT2_TT3, data = CAU[CAU$SEX.x ==2, ])
nzm_lm_additive=lm(BMI ~ as.factor(FULLEPGTAFF) + AGECOL + as.factor(SEX.x) + as.factor(DIABETES) +STANCESTRY+ RS8192678_CC1_CT2_TT3, data = nzm[nzm$SEX.x ==2, ])
cim_lm_additive=lm(BMI ~ as.factor(FULLEPGTAFF) + AGECOL + as.factor(SEX.x) + as.factor(DIABETES) +STANCESTRY+ RS8192678_CC1_CT2_TT3, data = cim[cim$SEX.x ==2, ])
samoan_lm_additive=lm(BMI ~ as.factor(FULLWPGTAFF) + AGECOL + as.factor(SEX.x) + as.factor(DIABETES) +STANCESTRY+ RS8192678_CC1_CT2_TT3, data = samoan[samoan$SEX.x ==2,])
tongan_lm_additive=lm(BMI ~ as.factor(FULLWPGTAFF) + AGECOL + as.factor(SEX.x) + as.factor(DIABETES) +STANCESTRY+ RS8192678_CC1_CT2_TT3, data = tongan[tongan$SEX.x == 2,])
